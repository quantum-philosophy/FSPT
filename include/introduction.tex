...
provides an overview of the prior work. In \sref{present-work}, the
contributions of our work are summarized. The problem that we address is
formalized in \sref{problem-formulation}. Our methodology and the corresponding
toolchain are described in \sref{methodology} and \sref{toolchain},
