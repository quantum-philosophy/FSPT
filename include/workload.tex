...
box labeled ``Recorder'' in \fref{methodology}. To elaborate, using an adequate
...
(see the box labeled ``Streamer'' in \fref{methodology}), the collected
...
tracking \sc{ALU}, \sc{FPU}, and so on individually. The resource allocation
...
\fref{methodology}. Note that a reference program can be recorded
