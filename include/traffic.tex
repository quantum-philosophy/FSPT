...
good example of traffic data, the interested reader is referred to a dataset
\cite{google} containing traffic data of a large computer cluster over a month
period; the dataset was made available for research purposes by Google in 2011.
Let us now move on to the analysis and synthesis of a chosen traffic pattern.
