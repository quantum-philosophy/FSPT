...
operation is referred to as job modeling in \fref{streamer}. At this point, it
might be helpful to recall \fref{streams}. The rest follows \sref{composition}.
The job stream is handled by a scheduling policy; in \fref{streamer}, this
