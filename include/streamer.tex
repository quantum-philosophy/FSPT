...
model.'' The rest follows \sref{composition}. Namely, the job stream is handled
...
based on the well-known thermal \sc{RC} model. We construct first a thermal
\sc{RC} circuit for the platform under consideration and then use it for
...
\sc{3D-ICE} \cite{sridhar2010} (see \fref{streamer}) depending on the user's
preferences.
