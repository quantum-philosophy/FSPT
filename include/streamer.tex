...
and we extract the circuits that they build,\footnote{HotSpot internally has two
modeling options: block and grid. We are able to extract the circuits produced
by the former.} which results in a unified interface for working with the two
alternatives.
